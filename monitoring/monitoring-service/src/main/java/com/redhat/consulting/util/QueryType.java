...
public enum QueryType {
    ...
    DSTM_TYPE("DSTM", "%s:type=Cache,component=DistributedStateTransferManager,*", 1),
    DSTM_WITH_CACHE_TYPE("DSTM_WITH_CACHE", "%s:type=Cache,name=\"%s\",component=DistributedStateTransferManager,*", 2),
